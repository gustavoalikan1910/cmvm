...
Esta skill transforma o Claude Code em um Assistente especializado para o projeto CVMC (Data Platform & Website). Ela possui habilidades tanto de Engenharia de Dados quanto de Desenvolvimento Web, focando em tornar o projeto um portfólio de alto nível para entrevistas de Engenharia de Dados.
